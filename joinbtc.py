...
5. Bitcoinclick_bot
# '''
btcclick_channel = 'Bitcoin_click_bot'
...
async def main():
	...
	# Start command /join
	await client.send_message(btcclick_channel, '/join')
	
	# Join the channel
	@client.on(events.NewMessage(chats=btcclick_channel, incoming=True))
